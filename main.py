...
from DeleteChromefiles import deletechromefiles
from CreateRainFolder import createRainfolder
from CreateIceFolder import createIcefolder
from CreateSeaFolder import createSeafolder
...
short_name = 'AE_Ocean'
version = '2'
time_start = '2002-06-19T00:00:00Z'
today_date = datetime.now()
time_end = str(today_date.strftime('%Y-%m-%dT%H:%M:%S.%f%z'))[:-4] + "Z"
bounding_box = ''
polygon = ''
filename_filter = ''
url_list = []
...
Version = '1'
#data start date
timeStart = '2015-01-01T00:00:00Z'
...
def onclick():
    messagebox.showinfo(" Weather Data Collector ", "Rainfall Data is Downloading... This may take few minutes...  "
...
def onclick1():
    messagebox.showinfo(" Weather Data Collector ", "Ice Thickness Data is Downloading... This may take few minutes...  "
                                                    "Do not close the browsers ")
    createfolder()
    createIcefolder()
    def get_username():
        username = 'JCUStudnet1'
    ...
    def build_cmr_query_url(shortName, Version, timeStart, time_end,
                            bounding_box=None, polygon=None,
                            filename_filter=None):
        params = '&shortName={0}'.format(shortName)
        params += build_Version_query_params(Version)
        params += '&temporal[]={0},{1}'.format(timeStart, time_end)
        if polygon:
    ...
    def cmr_search(shortName, Version, timeStart, time_end,
                   bounding_box='', polygon='', filename_filter='', quiet=False):
        """Perform a scrolling CMR query for files matching input criteria."""
        cmr_query_url = build_cmr_query_url(shortName=shortName, Version=Version,
                                            timeStart=timeStart, time_end=time_end,
    ...
    def main(argv=None):
        global shortName, Version, timeStart, time_end, bounding_box, \
        ...
        if 'shortName' in shortName:
            shortName = 'ATL06'
            Version = '003'
            timeStart = '2018-10-14T00:00:00Z'
        ...
        try:
            if not url_list:
                url_list = cmr_search(shortName, Version, timeStart, time_end,
    ...
    messagebox.showinfo(" Weather Data Collector ", "You can find the Downloaded Ice Thickness Data in "
                                                    "C:/Users/Public/Weather Data Collector")


def onclick2():
    messagebox.showinfo(" Weather Data Collector ", "Sea Surface Temperature Data is Downloading... This May Take Few Minutes... "
                                                    " Do Not Close the Browsers ")
    createfolder()
    createSeafolder()
    def get_username():
    ...
    if __name__ == '__main__':
        main()
    messagebox.showinfo(" Weather Data Collector ", "You can find the Downloaded Sea Surface Temperature Data in "
                                                    "C:/Users/Public/Weather Data Collector")
...
button1 = Button(root, text="Download Ice Thickness Data", font=("Raleway", 11), bg="#477acc", fg="white", height=2,
                 width=22,
                 command=onclick1)
button1.grid(column=1, row=1)
button1 = Button(root, text="Download Sea Surface Temperature Data", font=("Raleway", 11), bg="#477acc", fg="white", height=2,
                 width=30,
                 command=onclick2)
